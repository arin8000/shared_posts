    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-body bg-light mt-5">
                <h2>Login</h2>
                <p>Please fill in your credentials log in</p>
                <form action="<?php echo URLROOT; ?>/user/login" method="post">
                    <div class="form-group">
                       <label for="email">Email: <sup>*</sup></label> 
                       <input type="email" name="name" class="form-control form-control-lg <?php echo (!empty($data['email_err'])) ? 'is_invalid' : ''; ?>" value="<?php echo $data['email']; ?>">
